...
def Api_connect():
    Api_Id="AIzaSyAc5yh9GIFfaop4yMixH2KVqHZGuKpEAWU"
...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://Rex:Rexharrison27@atlascluster.nsahby2.mongodb.net/?retryWrites=true&w=majority")
...
icon = Image.open("C:/Users/User/Desktop/Youtube.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Rex Harrison",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Rex Harrison!*"""})
...
# Extracting the Data into MongoDB
if st.button("Collect and Store data"):
 ...
 # Transforming the data into SQL           
